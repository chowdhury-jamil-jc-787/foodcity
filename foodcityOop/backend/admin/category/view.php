...
<div class="wrapper">
        ...
        <div id="content">
            ...
            <a href="../category/index.php" class="btn btn-success btn-sm float-end">Back</a>
            </div>
                    ...
                    <div class="card-body">
                        <form method="post" action="#">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="user_name" disabled class="form-control" value = "<?php echo $row["name"]; ?>" />
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label class="col-sm-2 col-label-form">Description</label>
                                <div class="col-sm-10">
                                <textarea id="des" name="des"  class="form-control" disabled> </textarea>
