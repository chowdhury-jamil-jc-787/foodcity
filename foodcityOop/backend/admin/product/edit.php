...
if(count($_POST)>0) {
    ...
    if(isset($_FILES['user_image'])){
        ...
        move_uploaded_file($file_tmp,"../../../public/assets/img/product/".$file_name);
    }
	...
	<div class="card-body">
		<form method="post" action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" enctype="multipart/form-data">
			...
			<div class="row mb-4">
                ...
                <input class="form-check-input" type="radio" value="1" name="flexRadioDefault" id="flexRadioDefault1" <?php if($row["status"]==1){ echo "checked";} ?>>
                <label class="form-check-label" for="flexRadioDefault1">
                 Active
                </label>
                </div>
                <div class="form-check">
                <input class="form-check-input" type="radio" value="0" name="flexRadioDefault" id="flexRadioDefault2" <?php if($row["status"]==0){ echo "checked";} ?> >
            ...
            <div class="row mb-4">
				...
				<div class="col-sm-10">
                    ...
                    <?php foreach($results3 as $result3) { ?>
						...
						<option value="<?php echo $result3["id"];?>" <?php if($row["category_id"]===$result3['id']) echo 'selected="selected"';?>><?php echo $result3["name"]; ?></option>
			...
			<div class="row mb-4">
				...
				<div class="col-sm-10">
                    ...
                    <br />
                                    <img src="<?php echo "../../../public/assets/img/product/".$row['image']; ?>" class="img-thumbnail w-25" />
				</div>
			</div>
