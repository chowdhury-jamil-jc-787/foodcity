...
use FoodcityOop\product\Product;
$index = new Product();
...
<head>
    ...
    <title>Category view- Admin</title>
...
<div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="card-header"><a href="../product/index.php" class="btn btn-success btn-sm float-end">Back</a></div>
	<div class="card-body">
		<form method="post" action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" enctype="multipart/form-data">
			...
			<div class="row mb-3">
				...
				<div class="col-sm-10">
					<input type="text" disabled name="user_name" class="form-control" value = "<?php echo $row["name"]; ?>"/>
				</div>
			</div>
			<div class="row mb-3">
				<label class="col-sm-2 col-label-form">Description</label>
				<div class="col-sm-10">
                <textarea id="des" disabled name="des" class="form-control" ></textarea>
                <script>document.getElementById("des").value = "<?php echo $row["description"]; ?>"; </script>
				</div>
			</div>
			<div class="row mb-4">
				<label class="col-sm-2 col-label-form">Active</label>
				<div class="col-sm-10">
                <div class="form-check">
                <input class="form-check-input" disabled type="radio" value="1" name="flexRadioDefault" id="flexRadioDefault1" <?php if($row["status"]==1){ echo "checked";} ?>>
                <label class="form-check-label" for="flexRadioDefault1">
                 Active
                </label>
                </div>
                <div class="form-check">
                <input class="form-check-input" disabled type="radio" value="0" name="flexRadioDefault" id="flexRadioDefault2" <?php if($row["status"]==0){ echo "checked";} ?> >
            ...
            <div class="row mb-4">
				...
				<div class="col-sm-10">
                    ...
                    <?php foreach($results3 as $result3) { ?>
						...
						<option disabled value=""  <?php if($row["category_id"]===$result3['id']) echo 'selected="selected"';?>><?php echo $result3["name"]; ?></option>
            ...
            <div class="row mb-3">
				...
				<div class="col-sm-10">
					<input type="number" disabled name="price" class="form-control" value = "<?php echo $row["price"]; ?>"/>
				</div>
			</div>
            ...
            <div class="row mb-3">
				...
				<div class="col-sm-10">
					<input type="number" disabled name="quantity" class="form-control" value = "<?php echo $row["quantity"]; ?>"/>
                    <input type="hidden" name="stock" value="<?php if($row["quantity"]>0){ $stock = "in-stock"; }else{ $stock = "out-stock";} ?>" />
				</div>
			</div> 
			<div class="row mb-4">
				...
				<div class="col-sm-10">
                    ...
                    <br />
                                    <img src="<?php echo "../../../public/assets/img/product/".$row['image']; ?>" width="200" class="img-thumbnail" />
				</div>
			</div>
