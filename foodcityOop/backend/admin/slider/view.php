...
<div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="card-header"><a href="./index.php" class="btn btn-success btn-sm float-end">Back</a></div>
	<div class="card-body">
		<form method="post" action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" enctype="multipart/form-data">
			...
			<div class="row mb-4">
				...
				<div class="col-sm-10">
                    ...
                    <br />
                                    <img src="<?php echo "../../../public/assets/img/image_slider/".$row['image']; ?>" width="200" class="img-thumbnail" />
				</div>
			</div>
